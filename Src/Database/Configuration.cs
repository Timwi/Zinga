        ...
        protected override void Seed(Db db)
        {
            db.Constraints.AddOrUpdate(
                ...
                new Constraint
                {
                    ...
                    Public = true,
                    Kind = ConstraintKind.MatchingRegions
                },
                new Constraint
                {
                    Name = "Clone regions",
